package com.wenxin2.dt_mario_mixup;
...
@Mod(DynamicTreesMarioMixup.MOD_ID)
public final class DynamicTreesMarioMixup {

    public static final String MOD_ID = "dt_mario_mixup";

    public DynamicTreesMarioMixup() {
