...
dependencies {
    ...
    //Other
    runtimeOnly(fg.deobf("curse.maven:pehkui-319596:5393101"))
    runtimeOnly(fg.deobf("curse.maven:palette-lib-986014:5262463"))
    runtimeOnly(fg.deobf("curse.maven:scaremacs-super-mario-mod-861944:5622931"))
}
